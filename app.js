...
function updateDashboard(data) {
    ...
    dashboard.innerHTML = `
        <div class="card" onclick="showDetails('أيام الحضور', ${JSON.stringify(data.presentDetails)})">
            <h3>أيام الحضور</h3>
            <h2>${data.presentDays}</h2>
        </div>

        <div class="card" onclick="showDetails('الخصومات', ${JSON.stringify(data.deductionDetails)})">
            <h3>الخصومات</h3>
